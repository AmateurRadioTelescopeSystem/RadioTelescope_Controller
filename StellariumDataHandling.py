...
class StellariumData(object):
    ...
    def encodeStell(self, ra, dec):
        RaInt = int(ra * (2147483648.0 / 12.0))  # Calculate the Stellarium calibrated RA value
        DecInt = int(dec * (1073741824.0 / 90.0))  # Calculate the Stellarium calibrated DEC value
